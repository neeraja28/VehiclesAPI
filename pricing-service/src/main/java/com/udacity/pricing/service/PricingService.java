...
public class PricingService {
    ...
    /**
     *  Gets the prices of all the vehicles from the stored array.
     */
    public static PriceList getPriceList() throws PriceException {
        List<Price> priceList = new ArrayList<Price>();
        PriceList priceListResponse = new PriceList();
        for(int i=1; i<20;i++){
            priceList.add(getPrice(Long.valueOf(i)));
        }
        priceListResponse.setPriceList(priceList);
